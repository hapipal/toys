...
module.exports = exports = class {
    ...
    static handler(handlerOrServer, notation) {
        ...
        return internals.fromString(server, notation).method;
    }
    ...
    static pre(server, notation, options) {
        ...
        const parsed = internals.fromString(server, notation);
    ...
    // Includes BSD code from hoek, need to license correctly
    // See e.g. https://github.com/apache/thrift/blob/master/LICENSE
    ...
    static transformer(transform, options) {
        ...
        for (let i = 0; i < keys.length; ++i) {
            ...
            transformSteps.push({
                ...
                reacher: exports.reacher(sourcePath, options)
            });
        }
...
// Includes BSD code from hapi, need to license correctly
internals.fromString = function (server, notation) {
    ...
    result.method = (request, reply) => {
        ...
        args.push((err, value) => reply(err, value));
